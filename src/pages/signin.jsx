    ...
    <>
        <div className="container-fluid d-flex barre-de-navigation" id='barre-de-navigation'>
            ...
            <div className="container d-flex align-items-center justify-content-center">
                ...
                <div className="container ms-2">
                <Link to="/cygenete" className='navBtn1'>Retour</Link>
                </div>
            </div>
        </div>
                ...
                <div class="row mt-5">
                    ...
                    <div className="col-md-4 justify-content-center form-right">
                        <form action="" className='d-flex justify-content-center flex-column w-45 mt-5'>
                            ...
                            <input type="tel" name="phone" id="phone" className='input mb-2' placeholder='Numéro de téléphone' />

                            <label htmlFor="text">Date de naissance</label>
                            <input type="date" name="date" id="date" className='input mb-2' placeholder='dd/mm/yyyy' />
                            ...
                            <div className="btn btn-success rounded-pill">Comtinuer</div>
                        </form>
                        <hr />
                        <div className="container d-flex flex-column">
                            ...
                            <div type="button" class="btn btn-outline-success rounded-pill px-4 py-2 d-flex justify-content-center mb-5">
